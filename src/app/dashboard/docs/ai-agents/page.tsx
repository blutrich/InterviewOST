    ...
    <div className="space-y-8">
      ...
      <header className="space-y-4">
        ...
        <p className="text-lg text-gray-600">
          Discovery Co-Pilot uses 4 specialized AI agents, each trained on Teresa Torres&apos; Continuous Discovery methodology.
        </p>
      </header>
      ...
      <div className="space-y-10">
        ...
        <section className="space-y-4">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-xl font-medium text-gray-900">Planner Agent</h2>
          </div>
        ...
        <section className="space-y-4">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-xl font-medium text-gray-900">Interviewer Agent</h2>
          </div>
          <p className="text-gray-600">
        ...
        <section className="space-y-4">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-xl font-medium text-gray-900">Synthesizer Agent</h2>
          </div>
          <p className="text-gray-600">
        ...
        <section className="space-y-4">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-xl font-medium text-gray-900">Mapper Agent</h2>
          </div>
          <p className="text-gray-600">
