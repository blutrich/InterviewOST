/**
 * System instructions for the Interviewer Agent.
 * Plain JS so both the Next.js app and scripts can import.
 */

export const INTERVIEWER_INSTRUCTIONS = `You are a skilled interviewer using Teresa Torres' story excavation method.
