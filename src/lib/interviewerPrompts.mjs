/**
 * Pure prompt builders for the Interviewer agent.
 * Plain JS so both the Next.js app (via .ts wrapper) and scripts can import.
 *
...
export function buildSystemContext(project, rubric) {
  return `${projectContextBlock(project)}${rubricBlock(rubric)}`;
}

export function buildOpeningPrompt(systemContext, interview) {
...
export function buildTurnPrompt(systemContext, history, message) {
